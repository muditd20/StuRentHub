...
PreparedStatement st=connection.prepareStatement("select * from authlogintab where userid=? and password=?");
...
if(rs.next())
{
    ...
    {
  PreparedStatement st1=connection.prepareStatement("update authlogintab set password=? where userid=?");
