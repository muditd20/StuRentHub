...
PreparedStatement st=connection.prepareStatement("select * from ordertab");
    ...
    <body>
        <%@include file="adminheader.jsp"%>  
            <%
                ...
                {
                PreparedStatement st3=connection.prepareStatement("delete from ordertab where orderid="+records[i]);
                st3.executeUpdate();
            }
            response.sendRedirect("loadorders.jsp");
            }
             %>
                <form action="">
            ...
            %>
             <tr align="center">
              ...
              <%}%>
                 ...
                 <h2 align="center">DELETE ORDER SECTION</h2>
        <%
            ...
            {
            PreparedStatement st1=connection.prepareStatement("delete from ordertab");
            st1.executeUpdate();
            response.sendRedirect("loadorders.jsp");
        }
        if(button1!=null && button1.equalsIgnoreCase("Delete"))
            {
            PreparedStatement st2=connection.prepareStatement("delete from ordertab where orderid=?");
        ...
        <table align="center">
            ...
            <option>SELECT ORDER ID TO DELETE THE RECORD</option>
            <% for(int i=0;i<list1.size();i++){ %>
        ...
        <td><input type="submit" value="DELETE" name="b1">
            <input type="submit" value="DELETE ALL" name="b2"></td>
                ...
                <h2 align="center">SEARCH ORDER SECTION</h2>
                <%
                    String userId="";
                    String category="";
                    String productName="";
                    ...
                    {
                        PreparedStatement st4=connection.prepareStatement("select * from ordertab where orderid=?");
